    ...
    <table class="user-container">
        ...
        @foreach ($products as $product)
            <tr>
                ...
                <td>
                    <a href="{{ route('products.show', $product->slug) }}" class="green-button">Show</a>
                </td>
                <td>
                    <a href="{{ route('products.edit', $product->slug) }}" class="yellow-button">Edit</a>
                </td>
                <td>
...
<form action="/products" method="POST" class="form">
    ...
    <div class="user-input-container">
        ...
        <input class="user-input" type="text" name="number" required/>
    </div>
    <div class="user-input-container">
        <label class="user-label">Price</label>
        <input class="user-input" type="text" name="price" required/>
    </div>
